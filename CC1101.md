...
For this module you can also set a custom operating frequency in the supported subranges: `300-348` MHZ, `387-464` MHZ and `779-928` MHZ. Setting an empty or invalid frequency will reset to the default `433.9` MHZ.
